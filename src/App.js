...
class VoiceTest extends Component<Props, State> {
  ...
  onSpeechResults = (e: SpeechResultsEvent) => {
    ...
    var path = RNFS.DocumentDirectoryPath + '/voicelog.txt';
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.stat}>{`This was written to the file: ${this.state.read}`}</Text>
        ...
        <TouchableHighlight onPress={this._readVoiceLog}>
...
const Section = ({ children, title }) => {
  ...
  return (
    <View style={styles.sectionContainer}>
      <Text style={[styles.sectionTitle, { color: isDarkMode ? '#eee' : '#333' }]}>
        {title}
      </Text>
      <Text style={[styles.sectionDescription, { color: isDarkMode ? '#eee' : '#333' }]}>
        {children}
      </Text>
    </View>
  )
...
const App = () => {
  ...
  return (
    <SafeAreaView id='root' style={backgroundStyle}>
